const Footer = () => {
  ...
  return (
    <footer className="py-10 bg-white shadow-md">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="justify-between items-center gap-12 md:flex">
          ...
          <div className="flex-1 mt-6 md:mt-0">
            <form className="flex items-center gap-x-3 md:justify-end">
              ...
              <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-primary hover:bg-orange-500 active:bg-orange-700 active:shadow-none rounded-lg shadow">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="mt-10 py-10 border-t items-center justify-between sm:flex">
          <p className="text-gray-600">
            © 2022 Alzaf. All rights reserved.
          </p>
